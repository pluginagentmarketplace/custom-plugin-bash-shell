...
This guide provides comprehensive documentation for the **file-operations** skill in the custom-plugin-bash-shell plugin.
...
```bash
# Invoke the skill
claude "file-operations - [your task description]"

# Example
claude "file-operations - analyze the current implementation"
```
...
def implement_file_operations(input_data):
    """
    Implement file-operations functionality.
