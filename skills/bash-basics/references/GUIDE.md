...
This guide provides comprehensive documentation for the **bash-basics** skill in the custom-plugin-bash-shell plugin.
...
```bash
# Invoke the skill
claude "bash-basics - [your task description]"

# Example
claude "bash-basics - analyze the current implementation"
```
...
def implement_bash_basics(input_data):
    """
    Implement bash-basics functionality.
