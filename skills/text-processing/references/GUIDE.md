...
This guide provides comprehensive documentation for the **text-processing** skill in the custom-plugin-bash-shell plugin.
...
```bash
# Invoke the skill
claude "text-processing - [your task description]"

# Example
claude "text-processing - analyze the current implementation"
```
...
def implement_text_processing(input_data):
    """
