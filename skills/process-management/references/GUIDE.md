...
This guide provides comprehensive documentation for the **process-management** skill in the custom-plugin-bash-shell plugin.
...
```bash
# Invoke the skill
claude "process-management - [your task description]"

# Example
claude "process-management - analyze the current implementation"
```
...
def implement_process_management(input_data):
    """
